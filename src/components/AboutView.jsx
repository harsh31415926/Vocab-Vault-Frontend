  ...
  return (
    <div className="about-container">
      <section className="about-hero-card">
        ...
        <p>VocabVault is a private vocabulary and knowledge workspace for collecting words, attaching personal meaning to them, and returning often enough that they stop being unfamiliar.</p>
        <div className="about-hero-rule"><span />Built for my best friends only<span /></div>
      </section>

      <section className="about-card about-story-card">
        <div className="about-section-heading"><span className="section-index">01</span><div><span className="header-eyebrow">Why this exists</span><h3 className="about-title">Learn random words, store and revise it, and get your IELTS 8.5.</h3></div></div>
